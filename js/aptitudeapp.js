...
var optionsContainer = document.querySelector(".opt-container");
var answerIndicatorContainer = document.querySelector(".ans-indicator");
...
function quizResult(){
	...
	resultBox.querySelector(".tot-question").innerHTML = 50;
	...
	resultBox.querySelector(".tot-score").innerHTML = correctAnswers+" / 50";
}
